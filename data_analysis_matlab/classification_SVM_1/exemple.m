...
figure('Name','Représentation des images par des points 2D',...
    ...
    title('Données d''apprentissage non linéairement séparables')
    xlabel(nom_carac_1);
    ylabel(nom_carac_2);
    legend([f_ok,m_ok],'Fibromes','Mélanomes','Location','NorthWest');
    set(gca,'FontSize',20);
...
figure('Name','Représentation des images par des points 2D',...
    ...
    title('Données d''apprentissage linéairement séparables')
    xlabel(nom_carac_1);
    ylabel(nom_carac_2);
    legend([f_ok,m_ok],'Fibromes','Mélanomes','Location','NorthWest');
    set(gca,'FontSize',20);
