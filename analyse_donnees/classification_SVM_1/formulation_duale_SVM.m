...
% SVM (forme duale) :
[X_VS,w,c,code_retour] = SVM_dual(X_app,Y_app);
...
figure('Name','Classification par SVM','Position',...
	[0.51*L,0.1*H,0.47*L,0.7*H],'Color',[0.7 0.75 0.85]);
...
title('Données séparables - SVM (forme duale)')
legend([f_ok,m_ok,vs],...
