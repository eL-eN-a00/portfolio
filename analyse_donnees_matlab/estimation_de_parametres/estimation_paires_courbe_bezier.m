...
for j = 1:n
	...
	% Estimation des parametres par les moindres carres :
	parametres_MC = estimation_MC_2(d,x,bord_inf(:,j),bord_sup(:,j));
	...
	axis ij;
	grid on;
	title('Silhouettes estimees par deux bords jointifs');
	legend([hd, hi, hs],...
