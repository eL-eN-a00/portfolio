...
procedure Evaluer_Alea_TH is
	...
	is
      ...
      function Hachage(X : Integer) return Integer is
      begin
         return (X mod 11) + 1;
      end Hachage;
      ...
      package TH_Freq is
        ...
        (T_Cle            => Integer,
         T_Valeur         => Integer,
         T_Taille         => 11,
         Fonction_Hachage => Hachage);
      use TH_Freq;

      Frequences : T_THachage;
      Nombre : Integer;
      Val : Integer;
	...
	begin
      ...
      for I in 1..Taille loop
         ...
         Val := La_Valeur(Frequences, Nombre);
         Enregistrer (Frequences, Nombre, Val + 1);
      end loop;
      Min := La_Valeur(Frequences, 1);
      Max := Min;
      for I in 2..Borne loop
         Val := La_Valeur(Frequences, I);
         if Val > Max then
            Max := Val;
         elsif Val < Min then
            Min := Val;
